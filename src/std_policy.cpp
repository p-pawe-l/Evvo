...
std::pair<const IndPtr<double>*, const IndPtr<double>*> StdPolicy::choose_parents(
...
PopulationVec<double> StdPolicy::create_new_population(
    const PopulationVec<double>& prev, const PopulationEval<double>& eval
) {
